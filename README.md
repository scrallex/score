...
native manifold algorithms, manifold build logic and advanced scoring) should
...
pip install -e .
# Build the optional native manifold bindings (requires a C++20 toolchain and TBB)
...
with the native manifold kernel rather than the simplified fallback.
