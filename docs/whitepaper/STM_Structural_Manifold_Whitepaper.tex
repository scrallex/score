...
schedules. The lowest observed $p$-value (Logistics, $0.070$) suggests slight
sensitivity, but additional discriminative signals are required for stronger
claims.

\begin{table}[h]
  \centering
  \caption{Permutation statistics using $20{,}000$ iterations. Coverage-weighted is computed over all windows.}
