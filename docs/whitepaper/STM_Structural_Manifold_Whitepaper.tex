...
track instruments the production structural manifold stack: manifolds and trade-readiness
...
\begin{itemize}
  ...
  \item \textbf{Live engine exposure:} the production manifold loop emits native manifolds, repetition counts, and hazard $\lambda$ through \texttt{/api/manifold/latest} and the \texttt{/api/opt/slice*} family, allowing reviewers to replay the live admissibility gate.
