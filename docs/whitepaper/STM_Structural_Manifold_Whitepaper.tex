...
longer 512-byte foreground windows, and the addition of Logistics,
aggregate PlanBench, and robotics telemetry corpora into their twin libraries.
...
\begin{itemize}
  ...
  \item ingest real-world plan traces, robotic telemetry, and bug-fix commits
        via the new enrichment hooks (`PLANBENCH_EXTRA_TWINS`) to broaden the
